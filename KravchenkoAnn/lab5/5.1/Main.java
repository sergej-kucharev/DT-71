...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Äîäàâàííÿ åëåìåíòó:   Linked list  " +result1+ " Array List  " +result4+  " Treeset  " +result8+ " HashSet " +result11  );
        System.out.println("Âèäàëåííÿ åëåìåíòó:   Linked list  " +result2+ " Array List  " +result5+  " Treeset  " +result9+ " HashSet " +result12  );
        System.out.println("Çíàõîäæåííÿ åëåìåíòó:   Linked list  " +result3+ " Array List  " +result6+  " Treeset  " +result10+ " HashSet " +result13  );
    }
}
/*
Найменший час у додаванні займає HashSet, найбільший - TreeSet
Найменший час у видаленні займає HashSet, найбільший - ArrayList
Найменший час у знаходженні займає HashSet, найбільший - LinkedList
*/
