...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        workersList.add(new SalaryMan("uuu", 10500, 5678));
        workersList.add(new WageWorker("lll", 29, 7890));
        workersList.add(new SalaryMan("kkk", 20000, 1092));
        workersList.add(new WageWorker("ooo", 32, 2763));
        workersList.add(new WageWorker("ppp", 32, 1992));
        workersList.add(new SalaryMan("ggg", 108000, 1072));
        workersList.add(new WageWorker("eee", 55, 8732));
        workersList.add(new WageWorker("nnn", 80, 7924));
