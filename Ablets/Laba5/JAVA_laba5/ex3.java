...
public class ex3 {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        Worker_by_hour w1 = new Worker_by_hour(40, "Valera"),
                w2 = new Worker_by_hour(20, "Petya"),
                w3 = new Worker_by_hour(45, "Volodimir"),
                w4 = new Worker_by_hour(15, "Bob");
        Worker_by_month w5 = new Worker_by_month(3100, "Andrei"),
                w6 = new Worker_by_month(5000, "Alexei");
